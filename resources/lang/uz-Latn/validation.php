...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "additional_column1"    => "Qo'shimcha maydon 1",
        "additional_column2"    => "Qo'shimcha maydon 2",
        "additional_column3"    => "Qo'shimcha maydon 3",
        "category_id" => "Kategoriya",
        "title" => "Sarlavha",
        "short_desc" => "Qisqacha matn",
        "desc" => "To'liq matn",
        "publish_date" => "Sanasi",
        "icon" => "Ikonka",
        "color" => "Rang",
        ...
        "company_inn" => "Kompaniya inn",
        "specialist_id" => "Mutaxassislik",
        "skill" => "Mehnat staji",
        "r_order" => "Tartibi",
        "author" => "Muallif",
        "type_id" => "Turi",
