            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12" style="border: 1px solid #eee; padding: 20px;">
                    <form method="post" action="{{ route('vacancies.store') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <label for="specialist_id"
                                       class="col-form-label text-md-end">{{ __('Mavjud vakansiyani tanlang') }}</label>
                            ...
                            <div class="col-md-3" id="salary_hidden">
                                <label for="salary"
                                       class="col-form-label text-md-end">{{ __('Oylik maosh (so‘m)') }}</label>
                                <input id="salary" type="text" class="salary form-control" name="salary"
                                       value="{{ old('salary') ?? $vacancy->salary }}" required="required">
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="desc">Vakant haqida</label>
