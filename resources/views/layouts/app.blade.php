                ...
                <div class="row">
                    <div class="col-md-3">
                        <ul class="list-group">
                            ...
                            <a href="{{ route('admin.acceptable_rezumes') }}" class="list-group-item list-group-item-action @if(request()->segment(2) == 'accept' && (request()->segment(3) == 'rezumes' || request()->segment(3) == 'rezume')) active @endif"><i class="lni lni-check-mark-circle"></i> Tasdiqlanishi kutilayotgan rezumelar</a>
