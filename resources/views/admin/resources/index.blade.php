                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="{{ route('resource.create') }}" class="btn btn-primary btn-sm"><i class="lni lni-plus"></i> Qo'shish</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="btn-group">
                                                            <a href="{{ route('resource.show', ['resource' => $resource]) }}" class="btn btn-primary btn-sm"><i class="lni lni-eye"></i></a>
                                                            <a href="{{ route('resource.edit', ['resource' => $resource]) }}" class="btn btn-secondary btn-sm"><i class="lni lni-pencil"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
