...
@section('title', $resource->title . ' ni tahrirlash')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <b>{{ $resource->title }} ni tahrirlash</b>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('resource.update', ['resource' => $resource]) }}" method="post">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select name="type_id" id="type_id" class="form-control">
                                        ...
                                        @foreach($resource_types as $type)
                                            <option value="{{ $type->id }}" @if($resource->id == $type->id) selected @endif>{{ $type->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <label for="author">Muallif</label>
                                    <input type="text" name="author" class="form-control" id="author" value="{{ $resource->author }}">
                                </div>
                                <div class="col-md-4">
                                    <label for="link">Link</label>
                                    <input type="text" name="link" class="form-control" id="link" value="{{ $resource->link }}">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title" value="{{ $resource->title }}">
                                </div>
                                <div class="col-md-4">
                                    <label for="status">Holati</label> <br>
                                    <select name="status" id="status" class="form-control">
                                        <option value="">---</option>
                                        <option value="2" @if($resource->status == 2) selected @endif>Aktiv</option>
                                        <option value="1" @if($resource->status == 1) selected @endif>Aktiv emas</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <label for="r_order">Tartibi</label> <br>
                                    <input type="number" name="r_order" class="form-control" id="r_order" value="{{ $resource->r_order }}">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="desc" id="desc" cols="30" rows="10">{{ $resource->desc }}</textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
