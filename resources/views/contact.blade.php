...
@section('title', 'Biz bilan bog\'lanish')
                ...
                <div class="row contact-form-area">
                    <div class="col-md-12 col-lg-6 col-sm-12">
                        <div class="contact-block">
                            ...
                            @if(session()->has('sent_successfully'))
                                <div class="alert alert-success"><i class="lni lni-check-mark-circle"></i> {{ session()->get('sent_successfully') }}</div>
                            @endif

                            <form id="contactForm" method="post" action="{{ route('post_contact') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
