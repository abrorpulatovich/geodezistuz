        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12 col-xs-12" style="border: 1px solid #eeeeee; padding: 20px;">
                    ...
                    <form method="post" action="<?php echo e(route('vacancy.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="name" class="col-form-label text-md-end"><?php echo e(__('Nomlanishi')); ?></label>
                                <input id="name" type="text" class="name form-control" name="name" value="<?php echo e(old('name')); ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3" id="salary_hidden">
                                ...
                                <input id="salary" type="text" class="salary form-control" name="salary" value="<?php echo e(old('salary')); ?>">
                            </div>
                            <div class="col-md-3 mt-4">
                                <label class="col-form-label text-md-end">
                                    <input type="checkbox" id="is_salary" name="is_salary" value="0" class="hide_salary"><span> <?php echo e(__('Oylik kelishlgan holda')); ?></span>
                                </label>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/abrorkhan/Projects/Personal/geodezistuz/resources/views/profile/addvacancy.blade.php ENDPATH**/ ?>