                        ...
                        <form action="<?php echo e(route('post.store')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="short_desc" id="short_desc" cols="30" rows="5" class="form-control"><?php echo e(old('short_desc')); ?></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="p_order" class="form-control" id="p_order" value="<?php echo e(old('p_order')); ?>">
                                </div>
                                <div class="col-md-4">
                                    <label for="publish_date">Sanasi</label> <br>
                                    <input type="text" name="publish_date" class="form-control" id="publish_date" placeholder="kun-oy-yil" value="<?php echo e(old('publish_date')); ?>">
                                </div>
                            </div>
                            <br>
                            <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/abrorkhan/Projects/Personal/geodezistuz/resources/views/admin/post/create.blade.php ENDPATH**/ ?>