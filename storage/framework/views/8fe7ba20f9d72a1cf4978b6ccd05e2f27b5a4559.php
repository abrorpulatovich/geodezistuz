        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-12 col-xs-12" style="border: 1px solid #eee; padding: 20px;">
                    ...
                    <form method="post" action="<?php echo e(route('user_update_rezume', ['rezume' => $rezume])); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea name="about_me" id="about_me" cols="30" rows="5"><?php echo e($rezume->about_me); ?></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <label class="col-form-label text-md-end">
                                    <input
                                        ...
                                        id="is_history"
                                        name="is_history"
                                        <?php if($rezume->is_history == 1): ?>? checked <?php endif; ?>
                                        value="<?php echo e($rezume->is_history); ?>"
                                        class="history_hide"><span> <?php echo e(__('Mehnat staji mavjud emas')); ?></span>
                                </label>
                            </div>
                        </div>
                        <div id="hide_history" class="<?php echo e($rezume->is_history == 1? 'hidden': ''); ?>">
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $rezume->workbooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $workbook): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                        <input id="old_company_name" type="text"
                                                               class="old_company_name form-control"
                                                               name="workplaces[<?php echo e($key); ?>][old_company_name]"
                                                    ...
                                                    <td>
                                                        <input id="position_name" type="text"
                                                               ...
                                                               name="workplaces[<?php echo e($key); ?>][position_name]"
                                                    ...
                                                    <td>
                                                        <input id="from_date" type="text"
                                                               ...
                                                               name="workplaces[<?php echo e($key); ?>][from_date]"
                                                    ...
                                                    <td>
                                                        <input id="to_date" type="text"
                                                               ...
                                                               name="workplaces[<?php echo e($key); ?>][to_date]"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="name" class="col-form-label text-md"><?php echo e(__('Rezume nomlanishi')); ?></label>
                                <input type="text" name="name" value="<?php echo e($rezume->name); ?>" class="form-control"/>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="specialist_id" required id="specialist_id" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $specialists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($specialist->id); ?>" <?php if($rezume->specialist_id == $specialist->id): ?> selected <?php endif; ?> data-id="<?php echo e($specialist->id); ?>"><?php echo e($specialist->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="skill" required id="skill" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($skill->id); ?>" <?php if($rezume->skill == $skill->id): ?> selected <?php endif; ?> data-id="<?php echo e($skill->id); ?>"><?php echo e($skill->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6" id="salary_hidden">
                                <label for="salary" class="col-form-label text-md"><?php echo e(__('Siz kutayotgan maosh miqdori? (so‘m)')); ?></label>
...
<?php echo $__env->make('layouts.app_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/abrorkhan/Projects/Personal/geodezistuz/resources/views/profile/editrezume.blade.php ENDPATH**/ ?>