                        ...
                        <form action="<?php echo e(route('resource.store')); ?>" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="author" class="form-control" id="author" value="<?php echo e(old('author')); ?>">
                                </div>
                                <div class="col-md-4">
                                    <label for="link">Link</label>
                                    <input type="text" name="link" class="form-control" id="link" value="<?php echo e(old('link')); ?>">
                                </div>
                            </div>
                            <br>
                            <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/abrorkhan/Projects/Personal/geodezistuz/resources/views/admin/resources/create.blade.php ENDPATH**/ ?>