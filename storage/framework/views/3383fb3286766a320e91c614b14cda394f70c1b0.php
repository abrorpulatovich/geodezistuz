                ...
                <div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="widget">
                        ...
                        <ul class="menu">
                            ...
                            <li><a href="<?php echo e(route('news')); ?>">Yangiliklar</a></li>
                            <li><a href="<?php echo e(route('rezumes')); ?>">Rezumelar</a></li>
                            <li><a href="<?php echo e(route('vacancies')); ?>">Vakansiyalar</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="widget">
                        ...
                        <ul class="menu">
                            <?php $__currentLoopData = $latest_news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(route('news_details', ['slug' => $new->slug])); ?>"><i class="lni lni-arrow-right"></i> <?php echo e($new->title); ?></a></li>
...
<!-- Footer Section End -->
<?php /**PATH /Users/abrorkhan/Projects/Personal/geodezistuz/resources/views/layouts/footer.blade.php ENDPATH**/ ?>